...
// iteration. Chapter 5 implements that dispatch with explicit
// type-switch helpers (`nodeFindChild`, `nodeAddOrGrowChild`, ...).
// At two cases the duplication is bearable; at four cases (chapter
// 6 adds node16, chapter 8 adds node48) it becomes intolerable.
// That tension is why chapter 6 introduces method polymorphism --
...
// Hold on to that reading; chapter 6's diff will be exactly the
...
// node256 is unchanged from chapter 4 except for the explicit
...
// Range) dispatches through these. Chapter 6 will replace the
...
// Same short-circuited form as chapter 4.
...
//
// The shape mirrors chapter 4 but every inner-node access goes
...
//
// The reshape rules are the same as chapter 4 plus one: a node256
...
// becomes a node4. The collapse rules from chapter 4 (drop empty,
