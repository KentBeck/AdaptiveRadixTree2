...
The diff shape mirrors chapter 7 exactly: one new struct file
...
than chapter 7. Get is essentially unchanged from chapter 7 (and
...
slightly larger interface table. Same kind of cost as chapter 6,
same shape of trade.
...
same shape as chapter 7. **That is the chapter 6 polymorphism
...
Chapter 9 will be a reading guide to the production source plus
