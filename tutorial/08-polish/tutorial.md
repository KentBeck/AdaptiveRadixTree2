# Chapter 8 — Polish + reading guide

The structural work is done. The four-type ladder from chapter 7
...
**Measured impact** (1 000 keys per workload, chapter 7 → chapter 8):
...
of being adaptive. We made that trade in chapter 5; it lands at
...
- **`polymorphism-failed.md`** — the project's record of an
  ...
  `iterate.go`. (Chapter 5 of this tutorial cites it.)
...
You started chapter 1 with one node type that allocated 31 KB
