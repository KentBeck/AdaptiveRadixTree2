// Package addnode16 is chapter 7 of the literate tutorial. It is
// chapter 6's payoff: adding a third inner-node type now lands as
...
// node256 in chapter 6; in chapter 7 they settle into node16.
package addnode16
...
// inner-node type (chapter 7 has *node4, *node16, *node256;
// chapter 8 will add *node48). Every operation that used to do
// a type switch in chapter 5 now goes through one of these methods.
//
