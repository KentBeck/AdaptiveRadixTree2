// Package polish is chapter 9 of the literate tutorial. It is the
// final polish chapter: chapter 8's data structure plus three
...
//     one is zero-alloc.
//
// Each polish is shown below as a small diff against chapter 8
// and benchmarked against it. The end of the chapter is a reading
// guide pointing at the corresponding parent-package files.
//
// There is no chapter 10. The production art.Tree extends this
...
// inner-node type (chapter 8 has *node4, *node16, *node48,
// *node256 -- the full ART ladder). Every operation that used to
// do a type switch in chapter 5 now goes through one of these
// methods.
//
...
// node4 is the small inner node from chapter 5. Stores up to 4
